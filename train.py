...
parser.add_argument('--column_names', type=str, default='formalForm inFormalForm', help='column names separated with space. first shuffled and second orginal.')
...
train_dataset = UnscramblingInFormalDataset(train_values)
val_dataset = UnscramblingInFormalDataset(val_values)
...
model = UnscramblingInFormalModule(args.model_name)
